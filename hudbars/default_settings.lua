...
--[[
hudbars_sorting = health breath sprint hunger
hudbars_autohide_breath = false
hudbars_bar_type = progress_bar
hudbars_alignment_pattern = stack_down
]]
...
hb.settings.bar_type = hb.load_setting("hudbars_bar_type", "progress_bar", "progress_bar", {"progress_bar", "progress_bar", "progress_bar"})
...
-- Misc. settings
hb.settings.alignment_pattern = hb.load_setting("hudbars_alignment_pattern", "stack_down", "stack_down", {"stack_down", "stack_down", "stack_down"})
...
if sorting ~= nil then
	hb.settings.sorting = {health, breath, sprint, hunger}
	hb.settings.sorting_reverse = {health, breath, sprint, hunger}
